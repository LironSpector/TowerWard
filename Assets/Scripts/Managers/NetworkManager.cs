//// -------------------- New NetworkManager - after organizing and dividing NetworkManager to several classes --------------------
using UnityEngine;
using System;
...
public class NetworkManager : MonoBehaviour
{
    ...
    //[HideInInspector] public NetworkEncryptionManager encryptionManager;
    //[HideInInspector] public NetworkMessageHandler messageHandler;
    //[HideInInspector] public NetworkMessageSender messageSender;
    ...
    void Awake()
    {
        ...
        // Retrieve references to sub-managers
        //encryptionManager = GetComponent<NetworkEncryptionManager>();
        //messageHandler = GetComponent<NetworkMessageHandler>();
        //messageSender = GetComponent<NetworkMessageSender>();
    ...
    /// <summary>
    /// Send an already-encrypted base64 string with length prefix.
    /// Typically used after handshake for normal messages.
    /// </summary>
    //public void SendEncrypted(string cipherBase64)
    //{
    //    if (!isConnected || !isHandshakeCompleted) return;
    //    if (stream == null) return;
    ...
    //    //Debug.Log("[CLIENT] Sent ENCRYPTED: " + decryptedPlainJson);
    //}
    ...
    public void RequestMatchmaking()
    {
        ...
        // Use messageSender to actually send the request
...
//// -------------------- Previous NetworkManager - before organizing and dividing NetworkManager to several classes --------------------
//using UnityEngine;
//using System;
//using System.Net.Sockets;
//using System.Text;
